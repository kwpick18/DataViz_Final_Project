...
ui <- fluidPage(
  ...
  sidebarLayout(sidebarPanel(
    ...
    selected = "STL")),
                mainPanel(shinycssloaders::withSpinner(plotOutput("scatterplot"),
  ...
  tabPanel("YourChoice", fluid = TRUE, 
           ...
           sidebarLayout(sidebarPanel(
             selectInput("clubchoice", 
            label = "Choose a Hockey Team", choices= levels(factor(hockey_data$team)), 
            selected = "PIT"))), 
           #(sidebarPanel(selectInput("yearchoice", 
            #label = "Choose a Season", choices = levels(factor(hockey_data$season)), 
            #selected = "2008")) 
           #))
))))
