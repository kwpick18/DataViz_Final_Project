...
icetime_table_data2 <- icetime_table_data %>%
  mutate(., if_else("N.J", "NJD", team))


print(icetime_table_data)
  
## Use IF Else to change NJD to N.J and LAK to L.A
```
