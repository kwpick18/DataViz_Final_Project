...
var_choices <- names(hockey_data) [25:30] #39:41, 56, 73:78, 86, 89]
...
,
  ...
  tabPanel("YourChoice", fluid = TRUE, 
           ...
           sidebarLayout(sidebarPanel(
            ...
            selected = "PIT")), 
            radioButtons("varchoice1", label = "Choose a Statistic for the X-Axis", 
                         choices = var_choices), 
            radioButtons("varchoice2", label = "Choose a Statisitc for the Y-Axis", 
                         choices = var_choices),  
            mainPanel = plotOutput("yourchoicegraph") 
...
server <- function(input, output, session) {
  ...
  output$yourchoicegraph <- renderPlot({
    choice_viz()
  })
}
